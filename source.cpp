...
#include <conio.h>	   //used to include the console i/p & o/p
#include <string.h>	   //defines one variable type
using namespace std;
vector<vector<string>> content_seller;		//to store elements of same datatype
inline void initialize()					//improves the execution time & speed of the program
{
    cout << "\t\t\t\t========================================================================" << endl;
...
public:
    Medicine() //constuctor
    {
        ofstream medicine_sheet("stock_record.csv", ios::app); 	//used to open a file for writing
    ...
    ~Medicine()
    {
        // THIS IS A DESTRUCTOR   //a member function that is invoked automatically when the object is out of scope
    }
};
inline void add_medicine()			//improves the execution time & speed of the program
{
    Medicine m1;
    return;
}
